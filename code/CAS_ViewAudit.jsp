...
.style9 {color: #FFFFFF}
.style10 {font-family: "Times New Roman", Times, serif; font-weight: bold; font-size: 14px; color: #FFFFFF; }
-->
</style>
</head>
<body>
<div class="main">
  ...
  <tr>
   <td width="178" bgcolor="#FF0000"><div align="center" class="style8 style9"> Id</div></td>
    <td width="178" bgcolor="#FF0000"><div align="center" class="style10"> User</div></td>
      <td width="178" bgcolor="#FF0000"><div align="center" class="style10">File Name</div></td>
        <td width="140" height="32" bgcolor="#FF0000"><div align="center" class="style10">MAC</div></td>
   <td width="140" height="32" bgcolor="#FF0000"><div align="center" class="style10">Sk</div></td>
...
<%
  ...
  <tr>
    <td height="29"><div align="center" class="style7"><%=i%></div></td>
