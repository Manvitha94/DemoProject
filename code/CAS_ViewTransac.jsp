  ...
  <div class="content">
    <div class="content_resize">
        <div class="article">
          <h2>&nbsp;</h2>
          <h2>&nbsp;</h2>
          <h2>View <span class="style3"> Transactions</span> </h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
			 <table width="965" border="1" align="center" cellspacing="0" cellpadding="5">
  <tr>
   <td width="178" bgcolor="#FFFF00"><div align="center" class="style10 style6"><strong>Transaction Id</strong></div></td>
    <td width="178" bgcolor="#FFFF00"><div align="center" class="style10 style6"><strong>Transacted User</strong></div></td>
      <td width="178" bgcolor="#FFFF00"><div align="center" class="style10 style6"><strong>File Name</strong></div></td>
   <td width="140" height="32" bgcolor="#FFFF00"><div align="center" class="style10 style6"><strong>Task</strong></div></td>
	  <td width="115" bgcolor="#FFFF00"><div align="center" class="style10 style6"><strong>Date</strong></div></td>
  </tr>
