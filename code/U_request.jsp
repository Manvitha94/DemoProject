...
<div class="main">
 ...
 <% try 
	...
	String query="select * from opor_cloudserver where fname='"+file+"' "; 
...
if ( rs.next() )
{
 ...
 String sk="req";
			...
			stss.executeUpdate("insert into opor_userrequest(username,fnamereq,ownername,reqdate,resdate,mac,secretkey,resstatus) values ('"+username+"','"+file+"','"+on+"','"+reqdt+"','"+respdate+"','"+mac+"','"+sk+"','"+status+"')"); 
		
%>
 <h1 class="style18 style19">Hi Mr.<%=username %> ur request sent to Cloud Server </h1>
 <h3 class="style19"><a href="UserMain.jsp">Back</a></h3>
 <span class="style19">
 <%
}else{
 ...
 <h1 class="style18">Hi Mr.<%=username %> ur requesting File is not available in Cloud  </h1>
	<h3 class="style19">Please check the file name!!!</h3>
