...
.style8 {color: #FFFFFF}
.style9 {color: #FFFFFF; font-weight: bold; font-family: "Times New Roman", Times, serif; font-size: 14px; }
-->
</style>
</head>
<body>
  ...
  <div class="content">
    <div class="content_resize">
      ...
      try{
          ...
          String sql="SELECT * FROM opor_owner";
        ...
        %>
			  ...
			  <p>&nbsp;</p>
 <a href="CloudDataServerMain.jsp">Back</a>      </p>
              <div class="clr"></div>
    </div>
