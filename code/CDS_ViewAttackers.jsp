...
<head>
<title>View EDos Attackers</title>
...
.style9 {color: #FFFF00}
.style10 {color: #FFFF00; font-family: "Times New Roman", Times, serif; font-size: 14px; font-weight: bold; }
-->
</style>
</head>
<body>
  ...
  <div class="content">
    <div class="content_resize">
        <div class="article">
          <h2>&nbsp;</h2>
          <h2>&nbsp;</h2>
          <h2>View All <span class="style3">EDos Attackers</span> Details !!! </h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
        	<table width="965" border="1" align="center" cellspacing="0" cellpadding="5">
  <tr>
   <td width="178" bgcolor="#FF0000"><div align="center" class="style7 style9">Attacker Id</div></td>
    <td width="178" bgcolor="#FF0000"><div align="center" class="style10">Attacked User Name</div></td>
      <td width="178" bgcolor="#FF0000"><div align="center" class="style10">Sk</div></td>
   <td width="140" height="32" bgcolor="#FF0000"><div align="center" class="style10">Type</div></td>
...
<%
      	...
      	try 
	{
      		...
      		String query="select * from opor_attacker "; 
