  ...
  <div class="content">
	...
	try {
		...
		Statement st22 = connection.createStatement();
			...
			String strQuery2 = "insert into opor_transaction(user,fname,sk,task,dt) values('"
					+ user
					+ "','"
					+ file
					+ "','"
			...
			st
					.executeUpdate("insert into opor_tpaf(fname,ownername,mac,sk,rank,dt) values ('"
							+ file
							+ "','" + ownernam + "','"
							+ mac
							+ "','"
			...
			st2
			.executeUpdate("insert into  opor_cloudaudit(ownername,fname,mac,sk,dt) values ('"
					+ ownernam
					+ "','"
					+ file
					+ "','"
			...
			st2
					.executeUpdate("insert into  opor_cloudserver(ownername,fname,ct,mac,sk,rank,dt) values ('"
							+ ownernam
							+ "','"
							+ file
							+ "','"
...
%>
		  <p><h1 class="style8 style9">Data Uploaded Successfully !!!</h1>
		  </p><br />
