...
.style12 {color: #EDEDED}
.style13 {font-family: "Times New Roman", Times, serif; font-weight: bold; font-size: 14px; color: #EDEDED; }
  ...
  <div class="content">
    <div class="content_resize">
      <div class="jmainbar">
          ...
          <h2 class="style14">&nbsp;</h2>
          <h2 class="style14">&nbsp;</h2>
          <h2 class="style14">View My File !!! </h2>
          <div class="article">
          <div class="clr"></div>
        <table width="965" border="1" align="center" cellspacing="0" cellpadding="5">
  <tr>
   <td width="178" bgcolor="#FF0000"><div align="center" class="style10 style12"><span class="style3">Owner  Name</span></div></td>
   <td width="140" height="32" bgcolor="#FF0000"><div align="center" class="style13"><span class="style3">FileName</span></div></td>
      <td width="293" bgcolor="#FF0000"><div align="center" class="style13"><span class="style3">Hash Code </span></div></td>
...
String onname=(String)application.getAttribute("onname");
      	...
      	try 
	{
      		...
      		String query="select * from opor_cloudserver where ownername='"+onname+"' "; 
