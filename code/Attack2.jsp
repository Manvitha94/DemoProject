...
<%
	...
	try {
			...
			String strQuery3 = "Select * FROM opor_cloudserver where fname='"
				+ file + "'";
...
//fn,on,mac,sk
			...
			String dt = strDate + "   " + strTime;
				...
				String strQuery2 = "update opor_cloudaudit set mac='" + h1 + "',sk='" + pk
						+ "' where fname='" + file + "' ";
				connection.createStatement().executeUpdate(strQuery2);
			

			String strQuery25 = "insert into opor_attacker(user,fname,sk,type,dt) values('"
					+ on
					+ "','"
					+ file
					+ "','"
