  ...
  <div class="content">
    <div class="content_resize">
      ...
      <div class="sidebar">
        ...
        <div class="clr"></div>
        <div class="gadget">
          <h2 class="star style2">Cloud Server Menu</h2>
          <div class="clr"></div>
          <ul class="sb_menu">
		  
		   <li><a href="CAS_ViewOwner.jsp">View Owners & Authorize</a></li>
            <li><a href="CAS_ViewUsers.jsp">View Users & Authorize</a></li>
            <li><a href="CDS_ViewFiles.jsp">View Cloud Server Files</a></li>
			  <li><a href="Tpa_ViewMData.jsp">View Meta Data</a></li>
             <li><a href="CAS_ViewReq.jsp">View User Request</a></li>
          
            <li><a href="CDS_ViewTransactions.jsp">View Resource Usages and Transactions </a></li>
            <li><a href="CDS_ViewAttackers.jsp">View EDos Attackers </a></li>
			            <li><a href="CDS_TimeDelay_Results.jsp">View Time Delay Results </a></li>
						  <li><a href="CDS_Throughput_Results.jsp">View Throughput Results </a></li>
