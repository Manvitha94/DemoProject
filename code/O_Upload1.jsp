  ...
  <div class="content">
         ...
         <% try 
	{
			...
			h1 = bi1.toString(16);
      		...
      		String sql="select * from opor_cloudserver where fname='"+file+"'";
...
<table width="598" border="1" align="center" cellpadding="10" cellspacing="0">
	...
	<tr>
		<td width="286" bgcolor="#FF0000"><div align="center" class="style12"><span class="style10 style8 style4"><strong>File Name :- </strong></span></div></td>
		<td width="356"><input name="t42" type="text" id="t42" size="50"
			value="<%= file %>" readonly="readonly" /></td>
	</tr>
	<tr>
		<td width="286" bgcolor="#FF0000"><div align="center" class="style12"><span class="style10 style8 style4"><strong>Enc Content :- </strong></span></div></td>
		<td><textarea name="text1" cols="50" rows="15" readonly><%= cont %></textarea></td>
	</tr>
	<tr>
		<td width="286" bgcolor="#FF0000"><div align="center" class="style12"><span class="style10 style8 style4"><strong>Dec Content :- </strong></span></div></td>
		<td><textarea name="text2" cols="50" rows="15" readonly><%= encryptedValue %></textarea></td>
	</tr>
	<tr>
		<td bgcolor="#FF0000"><div align="center" class="style12"><span class="style10 style8 style4"><strong>Hash Code: </strong></span></div></td>
