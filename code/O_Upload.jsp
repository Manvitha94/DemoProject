        ...
        <div class="article">
         ...
         <form id="form1" name="form1" method="post" action="O_Upload1.jsp">
          <table width="598" border="1" align="center" cellspacing="0" cellpadding="10">
            <tr>
              <td width="286" bgcolor="#FF0000"><div align="center" class="style15"><span class="style4 style10 style11 ">Select File :- </span></div></td>
              <td width="356"><input name="t42" type="file" id="file"  onchange="loadFileAsText()" required="required" /></td>
            </tr>
            <tr>
              <td bgcolor="#FF0000" class="style4 style10 style11 style12"><div align="center" class="style15">File Name :- </div></td>
            ...
            <tr>
              <td bgcolor="#FF0000"><div align="center" class="style15"><span class="style4 style10 style11 ">Hash Code  :- </span></div></td>
