  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        ...
        <%
	 	...
	 	try {
	 		...
	 		String strQuery2 = "select * from opor_cloudserver where fname='"
	 ...
	 Statement st2 = connection.createStatement();
					String strQuery3 = "DELETE  FROM opor_cloudserver where id='"
									+ i + "' ";
							...
							st2.executeUpdate(strQuery3);
									...
									String strQuery4 = "DELETE  FROM opor_tpaf where fname='"
									+ file + "' ";
...
<p>
<h1 class="style10">Deleted SuccessFully!!!</h1>
</p>
<br />
<p><a
