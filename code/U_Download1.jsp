...
<div class="main">
  ...
  <%
	...
	String sts="Yes";
	String strQ = "select * from opor_userrequest where fnamereq='"+file+"' and username='"+user+"' and resstatus='"+sts+"'";
	...
	if(rs54.next()== true)
	{
				...
				String sk="";
				String oon="";
				String strQuery = "select * from opor_cloudserver where fname='"+file+"'";
				ResultSet rs = connection.createStatement().executeQuery(strQuery);
				{
					...
					String strQuery2 = "insert into opor_transaction(user,fname,sk,task,dt) values('"+user+"','"+file+"','"+sk+"','"+task+"','"+dt+"')";
		...
		<td width="245"><span class="style11">
		  ...
		  <input required name="t22"
			type="text"  size="40" value="<%=oon%>" readonly="readonly"/> 
              ...
              <tr>
                <td height="34" bgcolor="#A6EDFF"><span class="style10 style9 style8 style1"><strong>Hash Code  :-</strong></span></td>
		...
		%>
		<h1><%=user %> <span class="style16">ur Requested File is not been Permited by Cloud Audit Server!!<br/> 
		  Please Contact Cloud Admin!!!</span></h1>
		<p><a href="U_Download.jsp">Back</a></p>
		<%
	}
           connection.close();
...
%>
        ...
        <div class="gadget">
          <h2 class="star style9 style13">Data User Menu </h2>
          <div class="clr"></div>
          <ul class="ex_menu">
