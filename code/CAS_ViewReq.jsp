...
<div class="main">
 ...
 <td width="178" bgcolor="#46B5FF"><div align="center" class="style10 style9 style6 style14"><strong>Req Date</strong></div></td>
      <td width="178" bgcolor="#46B5FF"><div align="center" class="style10 style9 style6 style14"><strong>Res Date</strong></div></td>
       <td width="178" bgcolor="#46B5FF"><div align="center" class="style10 style9 style6 style14"><strong>Hash Code  </strong></div></td>
...
<%
      	...
      	try 
	{
      		...
      		String query="select * from opor_userrequest "; 
  ...
  <tr>
    ...
    <td height="29" bgcolor="#FFFF00"><div align="center" class="style16 style18"><%=s2%></div></td>
    <td bgcolor="#FFFF00"><div align="center" class="style19"><%=s3%></div></td>
    <td bgcolor="#FFFF00"><div align="center" class="style19"><%=s4%></div></td>
	  <td bgcolor="#FFFF00"><div align="center" class="style19"><%=s5%></div></td>
	     <td bgcolor="#FFFF00"><div align="center" class="style19"><%=s6%></div></td>
    <td bgcolor="#FFFF00"><div align="center" class="style19"><%=s7%></div></td>
    <td bgcolor="#FFFF00"><div align="center" class="style19"><%=s8%></div></td>
	  <td bgcolor="#FFFF00"><div align="center" class="style19"><a href="CAS_Process.jsp?id=<%=i%>&fname=<%=s3%>&sts=<%=s9%>"><%=s9%></a></div></td>
  </tr>
