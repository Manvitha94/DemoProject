  ...
  <%
		   	try {
		   		...
		   		String strQuery = "select * from opor_cloudserver where fname='"
		   				...
		   				+ mac
		   				+ "' and  sk='" + sk + "'";
		   		String strQuery1 = "select * from opor_cloudserver where fname='"
		   				+ file + "'";
		   ...
		   %>
					...
					int updaterank = Integer.parseInt(rank)+ 1;
						...
						<%
												String strQuery2 = "update opor_cloudserver set rank='"
														+ updaterank
														+ "' where fname='"
														+ file+ "'";
						%>
		  ...
		  <p>
		  <h1 class="style1 style10 style12">File Doesn't Exist !!!</h1>
		  </p>
		  <span class="style12"><br />
		  </span>
		  <p class="style12"><a href="Download.jsp">Back</a></p>
	      <span class="style12">
	      <%
		}
					}
...
String type="Wrong Credentials";
					String strQuery2 = "insert into opor_attacker(user,fname,sk,type,dt) values('"
							+ user
							+ "','"
							+ file
							+ "','"
	...
	%>
	      ...
	      <p class="style12">
		  <h1 class="style1 style10">MAC / Secret Key Mismatch !!!</h1>
		  </p><br />
	...
	%>
        ...
        <div class="gadget">
          <h2 class="star style9">Data User Menu </h2>
          <div class="clr"></div>
          <ul class="ex_menu">
