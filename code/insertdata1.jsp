	...
	try {
		...
		while (files.hasMoreElements()) {
			...
			if (paramname != null) {
				...
				String query1 = "SELECT * FROM opor_user WHERE name='"
						+ uname + "' ";
...
<%
					...
					PreparedStatement ps = connection
							.prepareStatement("INSERT INTO opor_user(name,pass,email,mobile,addr,dob,gender,pin,location,imagess,status) values(?,?,?,?,?,?,?,?,?,?,?) ");
