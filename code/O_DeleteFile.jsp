    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li><a href="CloudAuditServer.jsp"><span>Cloud Audit Server </span></a></li>
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
        <form id="form1" name="form1" method="post" action="O_Delete.jsp">
          <table width="598" border="1" align="center" cellpadding="10" cellspacing="0">
           
            <tr>
              <td class="style4 style10">File Name :- </td>
