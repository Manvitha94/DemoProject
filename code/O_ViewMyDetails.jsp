...
.style12 {font-family: "Times New Roman", Times, serif; font-size: 14px; color: #FFFFFF; }
-->
</style>
</head>
<body>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="jmainbar">
          ...
          <h2>&nbsp;</h2>
          <h2>&nbsp;</h2>
          <h2>View<span class="style9"> My Details </span> </h2>
          <div class="article">
          <div class="clr"></div>
        ...
        try{
          ...
          String sql="SELECT * FROM opor_owner WHERE name='"+un+"'";
